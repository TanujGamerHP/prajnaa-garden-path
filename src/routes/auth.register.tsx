      ...
      <div className="container-prj grid place-items-center py-16 md:py-20">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-2 text-center text-sm text-muted-foreground">
            Join the Prajnaa Farm community.
          </p>
          ...
          <form onSubmit={onSubmit} className="space-y-3">
            <input
              ...
              className="font-subhead h-12 w-full rounded-full border border-border bg-background px-5 text-sm outline-none focus:border-primary"
            />
            <input
              name="email"
              type="email"
            ...
            <button
              disabled={loading}
              className="font-subhead inline-flex h-12 w-full items-center justify-center gap-2 rounded-full bg-primary text-sm font-medium text-primary-foreground transition-opacity hover:opacity-90 disabled:opacity-60"
            >
