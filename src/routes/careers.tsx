...
const roles = [
  ...
  {
    t: "Senior Backend Engineer (NestJS)",
    team: "Engineering",
    loc: "Remote, India",
    type: "Full-time",
  },
  ...
  {
    t: "Warehouse Operations Manager",
    team: "Operations",
    loc: "Anand, Gujarat",
    type: "Full-time",
  },
...
const values = [
  {
    t: "Soil first",
    d: "Every product decision starts at the farm. If it's not good for the soil, it's not on Prajnaa.",
  },
  {
    t: "Traceable by default",
    d: "We can name every farmer, every batch, every test. If we can't, we don't ship it.",
  },
  {
    t: "Honest economics",
    d: "Farmers know our margin. Customers know our cost. No fine print, ever.",
  },
  {
    t: "Quietly excellent",
    d: "Loud marketing is easy. We'd rather the jar in your kitchen do the talking.",
  },
];
  ...
  head: () => ({
    meta: [
      { title: "Careers — Prajnaa Farm" },
      {
        name: "description",
        content:
          "Open roles at Prajnaa Farm. Build the supply chain for the next generation of Indian food.",
      },
  ...
  return (
    <MarketingLayout>
      <PageHero
        ...
        title={
          <>
            Build food commerce <span className="text-primary">that pays the grower.</span>
          </>
        }
      ...
      <section className="container-prj pb-24">
        <Reveal>
          <div className="flex items-end justify-between">
            ...
            <p className="font-subhead hidden text-xs uppercase tracking-[0.16em] text-muted-foreground md:block">
        ...
        <ul className="mt-8 divide-y divide-border overflow-hidden rounded-3xl border border-border bg-background">
          {roles.map((r, i) => (
            <Reveal as="li" key={r.t} delay={i * 50}>
              <Link
                to="/contact"
                className="group flex flex-col gap-3 p-6 transition-colors hover:bg-secondary/30 md:flex-row md:items-center md:justify-between md:p-7"
              >
                <div>
                  <p className="font-subhead text-[11px] uppercase tracking-[0.16em] text-accent">
                    {r.team}
                  </p>
