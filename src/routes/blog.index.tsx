  ...
  head: () => ({
    meta: [
      { title: "The Journal — Prajnaa Farm" },
      {
        name: "description",
        content:
          "Farmer stories, recipes, and field notes from across India. Slow reading from the people growing your food.",
      },
  ...
  return (
    <MarketingLayout>
      <PageHero
        ...
        title={
          <>
            Slow reading from the <span className="text-primary">field.</span>
          </>
        }
          ...
          >
            ...
            <div className="flex flex-col justify-between gap-8 p-8 md:p-12">
              <div>
                ...
                <h2 className="font-display mt-4 text-3xl font-semibold leading-[1.1] md:text-4xl">
                  {featured.title}
                </h2>
